...
/** Read-only overview of an exam (used for the public pool): ordered questions, type + point. */
export function ExamDetailDialog({ open, onOpenChange, exam, isLoading }: ExamDetailDialogProps) {
