...
internal static class AssignmentDetailLoader
{
    ...
    )
    {
        ...
        return new AssignmentDetailDto
        {
            ...
            RequireFullscreen = view.RequireFullscreen,
            DetectTabSwitch = view.DetectTabSwitch,
            BlockCopyPaste = view.BlockCopyPaste,
            MaxViolations = view.MaxViolations,
            ViolationAction = view.ViolationAction,
